...
public class LibraryDashboardWindow extends JFrame implements LibWindow {
    public static final LibraryDashboardWindow INSTANCE = new LibraryDashboardWindow();
...
//    private JButton viewBooksButton;
    ...
    private LibraryDashboardWindow() {}
    ...
    public void init() {
        ...
        LibraryDashboardWindow.INSTANCE.setTitle( role + " Dashboard");
...
//        mainPanel.add(viewBooksButton);
    ...
    private void defineTopPanel() {
        ...
        JLabel label = new JLabel("You are in " + role + " Dashboard");
