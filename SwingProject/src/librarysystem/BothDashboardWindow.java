...
public class BothDashboardWindow extends JFrame implements LibWindow {
    public static final BothDashboardWindow INSTANCE = new BothDashboardWindow();
    ...
    public void init() {
        ...
        BothDashboardWindow.INSTANCE.setTitle( role + " Dashboard");
